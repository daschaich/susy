...
// -----------------------------------------------------------------
// Smear by multiplying in (determinant-divided?) staple sum
// Overwrite s->linkf and save original values in thin_link field
void staple_smear(int Nstout, double rho) {
  ...
  for (n = 0; n < Nstout; n++) {
    for (dir = XUP; dir < NUMLINK; dir++) {
      ...
      // TODO: Define smeared_link for all sites
      // TODO: Possibly divide out determinant (second round?)
