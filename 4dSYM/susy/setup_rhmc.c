...
void setup_rhmc16() {
#if (DEGREE==16)
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < out.000000001-500
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < out.000000001-500
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < out.000000001-500
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < out.000000001-500
...
// -----------------------------------------------------------------
// (10, 10) approximation for spectral range [0.0005, 1000]
// gives errors 1.718292e-05 and 9.257843e-06
void setup_rhmc10() {
#if (DEGREE==10)
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < out.0005-1000
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < out.0005-1000
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < out.0005-1000
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < out.0005-1000
...
void setup_rhmc7() {
#if (DEGREE==7)
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < out.001-150
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < out.001-150
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < out.001-150
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < out.001-150
