...
// -----------------------------------------------------------------
// (12, 12) approximation for spectral range [5e-5, 2000]
// gives errors 1.446502e-05 and 7.799051e-06
void setup_rhmc12() {
#if (DEGREE==12)
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < out.D12
  ampdeg4 = 7.9513299070099519e-02;
  amp4[0] = 1.7861315065015914e-04;
  amp4[1] = 5.7507499089222609e-04;
  amp4[2] = 1.8917178488249335e-03;
  amp4[3] = 6.3419570499041204e-03;
  amp4[4] = 2.1353571536269090e-02;
  amp4[5] = 7.1963614434670031e-02;
  amp4[6] = 2.4260592316583041e-01;
  amp4[7] = 8.1857674221428078e-01;
  amp4[8] = 2.7734025272500746e+00;
  amp4[9] = 9.5949779932341883e+00;
  amp4[10] = 3.6934949278520996e+01;
  amp4[11] = 2.5385445301435436e+02;

  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < out.D12
  shift4[0] = 1.4684892647002443e-05;
  shift4[1] = 1.5228364705963324e-04;
  shift4[2] = 8.6539912694514633e-04;
  shift4[3] = 4.4729346447237566e-03;
  shift4[4] = 2.2705838382551687e-02;
  shift4[5] = 1.1485568363186879e-01;
  shift4[6] = 5.8063561607564440e-01;
  shift4[7] = 2.9362793993784471e+00;
  shift4[8] = 1.4883473506794134e+01;
  shift4[9] = 7.6351259721818607e+01;
  shift4[10] = 4.1681571605114141e+02;
  shift4[11] = 3.2707778477710790e+03;

  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < out.D12
  ampdeg8 = 3.5288307803953520e+00;
  amp8[0] = -2.3198517611319218e-06;
  amp8[1] = -1.6372445082601334e-05;
  amp8[2] = -1.0262139358262650e-04;
  amp8[3] = -6.3608247827235136e-04;
  amp8[4] = -3.9357938889863654e-03;
  amp8[5] = -2.4346196511607826e-02;
  amp8[6] = -1.5063189143441810e-01;
  amp8[7] = -9.3320761319714418e-01;
  amp8[8] = -5.8207049438204157e+00;
  amp8[9] = -3.7571427550296320e+01;
  amp8[10] = -2.8925389351697459e+02;
  amp8[11] = -6.0807723251527605e+03;

  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < out.D12
  shift8[0] = 2.6070661734818193e-05;
  shift8[1] = 2.1515669104537499e-04;
  shift8[2] = 1.1833962559284015e-03;
  shift8[3] = 6.0769442317989645e-03;
  shift8[4] = 3.0796770696173804e-02;
  shift8[5] = 1.5567051024158129e-01;
  shift8[6] = 7.8657165844440813e-01;
  shift8[7] = 3.9764865970527068e+00;
  shift8[8] = 2.0166724413849568e+01;
  shift8[9] = 1.0394538172842327e+02;
  shift8[10] = 5.8315669130373715e+02;
  shift8[11] = 5.5110367801402081e+03;
#endif
}
// -----------------------------------------------------------------
...
void setup_rhmc() {
  ...
  switch(Norder) {
    ...
    case 11:
      ...
      break;
    case 12:
      node0_printf("[5e-5, 2000]\n");
      setup_rhmc12();
      break;
    case 14:
      node0_printf("[1.5e-6, 2000]\n");
      setup_rhmc14();
      break;
    case 15:
