...
// -----------------------------------------------------------------
// (9, 9) approximation for spectral range [0.001, 100]
// gives errors 5.521922e-06 and 2.973723e-06
void setup_rhmc9() {
#if (DEGREE==9)
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < out.0001-100
  ampdeg4 = 1.6185036211305143e-01;
  amp4[0] = 1.4755565150868448e-03;
  amp4[1] = 4.3811620276722777e-03;
  amp4[2] = 1.3141602014946121e-02;
  amp4[3] = 4.0252328958891657e-02;
  amp4[4] = 1.2413989552436894e-01;
  amp4[5] = 3.8570669649753764e-01;
  amp4[6] = 1.2324474017539884e+00;
  amp4[7] = 4.4680602560514018e+00;
  amp4[8] = 3.0036255019561803e+01;

  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < out.0001-100
  shift4[0] = 2.4897453354836240e-04;
  shift4[1] = 2.4259368731045870e-03;
  shift4[2] = 1.2522061471520251e-02;
  shift4[3] = 5.7921861635054119e-02;
  shift4[4] = 2.6195857460233213e-01;
  shift4[5] = 1.1828327127954723e+00;
  shift4[6] = 5.4204972820778607e+00;
  shift4[7] = 2.6740329266468176e+01;
  shift4[8] = 1.9507386190561667e+02;

  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < out.0001-100
  ampdeg8 = 2.4734855482234663e+00;
  amp8[0] = -5.4521917712376972e-05;
  amp8[1] = -3.4385591311988857e-04;
  amp8[2] = -1.8930454573904448e-03;
  amp8[3] = -1.0281574851579652e-02;
  amp8[4] = -5.5831957450306564e-02;
  amp8[5] = -3.0604441916820690e-01;
  amp8[6] = -1.7538144670941751e+00;
  amp8[7] = -1.2330143407338591e+01;
  amp8[8] = -2.4922441791294827e+02;

  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < out.0001-100
  shift8[0] = 4.3828092564444411e-04;
  shift8[1] = 3.3708495843949786e-03;
  shift8[2] = 1.6772257075384919e-02;
  shift8[3] = 7.6965005411228513e-02;
  shift8[4] = 3.4743010649024331e-01;
  shift8[5] = 1.5695978224954954e+00;
  shift8[6] = 7.2359769547345349e+00;
  shift8[7] = 3.6818763109795761e+01;
  shift8[8] = 3.2599460438423904e+02;
#endif
}
// -----------------------------------------------------------------
